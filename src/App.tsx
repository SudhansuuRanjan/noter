...
function SecondaryLayout() {
    ...
    if (!activeNote) {
        return (
            <div className="flex-1 min-h-0 min-w-0 flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 h-full w-full">
    ...
    return (
        <div className="h-full w-full min-h-0 min-w-0 flex flex-col overflow-hidden bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 font-sans" role="application" aria-label="Noter secondary preview window">
            {hasCustomTitleBar ? (
                <WindowTitleBar title={activeNote.title} />
            ) : (
                <header
            ...
            <div className="flex-1 min-h-0 min-w-0 overflow-hidden" role="main" aria-label="Note preview">
                <Preview />
            </div>
        </div>
    )
...
function WelcomeScreen({ createNote, ensureHistorySynced }: { createNote: () => void | Promise<void>, ensureHistorySynced: () => Promise<boolean> }) {
    return (
        <main className="flex-1 min-h-0 min-w-0 flex flex-col items-center justify-center bg-zinc-50 dark:bg-zinc-950/50 relative overflow-hidden" aria-label="Welcome screen">
    ...
    return (
        <div className="flex h-full w-full min-h-0 min-w-0 overflow-hidden bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 font-sans" role="application" aria-label="Noter note taking app">
            <div className="flex-1 min-h-0 min-w-0 flex flex-col">
                {hasCustomTitleBar && <WindowTitleBar showSearch />}
                    ...
                    <PanelGroup direction="horizontal">
                        ...
                        >
                            {activeNote ? (
                                ...
                                <WelcomeScreen createNote={createNote} ensureHistorySynced={ensureHistorySynced} />
                            )}
                        </Panel>
                    </PanelGroup>
                </div>
